...
Thiết kế cho desktop ≥1280px (density dispatch console). Mọi grid dùng `auto-fit/minmax` nên
xuống 900px vẫn xếp lại được. Khi làm bản mobile cho vai `member`, ưu tiên 3 màn: Trang chủ,
Chia sân, Trang cá nhân — theo density "Driver App" (target 48px, primary action 56px, body ≥16px).
