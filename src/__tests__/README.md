...
| **Edge cases matchSearch**: `neverMetWithSessionCount` với attendance=false · fallback qua matches · `topDisparatePairs` limit · `rankPairs` minGames filter | `lib/match_search_edge.test.js` |
